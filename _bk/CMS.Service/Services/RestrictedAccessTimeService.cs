...
namespace CMS.Service
{
    public class RestrictedAccessTimeService : IRestrictedAccessTimeService
    {
        ...
        public void Delete(int id, DeleteState deleteState)
        {
            ...
            if (restrictedAccessTime != null)
            {
                _restrictedAccessTimeRepository.Delete(restrictedAccessTime, deleteState);
            }
            else
            {
                try
        ...
        public int DeleteAll(string items)
        {
            try
            {
                ...
                idsToRemove.ForEach(i => _restrictedAccessTimeRepository.Delete(i, DeleteState.SoftDelete));
