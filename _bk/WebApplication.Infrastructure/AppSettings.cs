...
namespace WebApplication.Infrastructure
{
    public static class AppSettings
    {
        ...
        public static readonly string CONNECTION_STRING = ConfigurationManager
            .ConnectionStrings["AttendanceLite"].ConnectionString;
        #endregion

        #region Logging
        public static readonly string APP_LOGS_FILE_PATH = ConfigurationManager
            .AppSettings["LOGGER_FILEPATH"];
        public static readonly bool IS_USER_LOGGING_ENABLED = bool.Parse(ConfigurationManager
            .AppSettings["IS_USER_LOGGING_ENABLED"] ?? "false");
        #endregion
        ...
        #region AccessIds
        public static readonly Guid ManagerDashboardAccessId =
            Guid.Parse(ConfigurationManager.AppSettings["ManagerDashboardAccessId"]);
        public static readonly Guid PersonnelDashboardAccessId =
            Guid.Parse(ConfigurationManager.AppSettings["PersonnelDashboardAccessId"]);
        #endregion
    }
}
